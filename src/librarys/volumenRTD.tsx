...
const VolumenRTD = () => {
    ...
    const handleCalcular = () => {
        const case1 = getValue("case1");
        const case2 = getValue("case2");
        const q1 = parseFloat(getValue("cant1")) || 0;
        const q2 = parseFloat(getValue("cant2")) || 0;
        const q3 = parseFloat(getValue("cant3")) || 0;
        const q4 = parseFloat(getValue("cant4")) || 0;
