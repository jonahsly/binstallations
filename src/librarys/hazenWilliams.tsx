...
const HazenWilliams = () => {
    ...
    const handleCalcular = () => {
        const Q = parseFloat(getValue("caudalH")) || 0;
        const L = parseFloat(getValue("longH")) || 0;
        const D = parseFloat(getValue("diamH")) || 0;
        const C = parseFloat(getValue("coefC")) || 0;
    ...
    <>
        ...
        <div className="method-container">
            ...
            <div className="calculate-container">
                ...
                <div>Pérdida de carga: <MathRenderer math={"\\Delta H_f"}/> = {result.hf} (mca)</div>
            </div>
        </div>
    </>
    );
